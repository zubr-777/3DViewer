...
QT_MOC_LITERAL(1, 11, 18), // "basis_view_changed"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "myglwidget\0basis_view_changed\0"
};
...
void myglwidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->basis_view_changed(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myglwidget::basis_view_changed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myglwidget::basis_view_changed()
{
